...
const packages = ['tokens-foundation', 'tokens-brand', 'tokens-creator', 'tokens-atmosphere', 'tokens-studio', 'tokens-oportunities', 'tokens-hexcoded'];
...
for (const theme of ['light', 'dark']) {
  ...
  for (const pkg of ['tokens-brand', 'tokens-atmosphere', 'tokens-creator', 'tokens-studio', 'tokens-oportunities', 'tokens-hexcoded']) {
