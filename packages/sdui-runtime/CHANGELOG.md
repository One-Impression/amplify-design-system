...
- [#290](https://github.com/One-Impression/amplify-design-system/pull/290) [`067978f`](https://github.com/One-Impression/amplify-design-system/commit/067978f1b9fc518794836e4fbc8beebb95015504) Thanks [@achin-oi](https://github.com/achin-oi)! - Vertical `group_config` children now inherit the page's per-item vertical rhythm by default, instead of a fixed `sm` gap. Spacing resolves in precedence: a child node's own `gap` (per-child, backend) → the group's `gap` (group-wide, backend) → the inherited page default (half-gutter). A plain (cardless) vertical group is now spacing-transparent — its children space exactly as if inlined at the page level (first child's top and last child's bottom are zeroed, since the group already sits in the page gutter). Horizontal groups are unchanged (they keep the uniform `Box` gap, default `sm`).

## 4.3.0

### Minor Changes

- [#286](https://github.com/One-Impression/amplify-design-system/pull/286) [`9095c78`](https://github.com/One-Impression/amplify-design-system/commit/9095c78d67725c959efaa541f4b8aa57ba123cd7) Thanks [@achin-oi](https://github.com/achin-oi)! - Vertical `group_config` children now inherit the page's per-item vertical rhythm by default, instead of a fixed `sm` gap. Spacing resolves in precedence: a child node's own `gap` (per-child, backend) → the group's `gap` (group-wide, backend) → the inherited page default (half-gutter). A plain (cardless) vertical group is now spacing-transparent — its children space exactly as if inlined at the page level (first child's top and last child's bottom are zeroed, since the group already sits in the page gutter). Horizontal groups are unchanged (they keep the uniform `Box` gap, default `sm`).

## 4.2.0

### Minor Changes

- [#282](https://github.com/One-Impression/amplify-design-system/pull/282) [`3fdec12`](https://github.com/One-Impression/amplify-design-system/commit/3fdec127b9c642f3350ffbe80dcdc2357c427bf6) Thanks [@achin-oi](https://github.com/achin-oi)! - Search-in-bottomsheet primitives (powers type-to-search pickers, e.g. location):
...
- [#278](https://github.com/One-Impression/amplify-design-system/pull/278) [`55fe39a`](https://github.com/One-Impression/amplify-design-system/commit/55fe39a228e27d625865cde1aa2cdbaa0b0eb481) Thanks [@achin-oi](https://github.com/achin-oi)! - Form primitives + fixes for multi-field creator forms:
...
- [#275](https://github.com/One-Impression/amplify-design-system/pull/275) [`2ce2e81`](https://github.com/One-Impression/amplify-design-system/commit/2ce2e813002aea3ee362eb7b7048848a9293cd8e) Thanks [@achin-oi](https://github.com/achin-oi)! - Single-source the gutter/gap model across pages and sheets, and refine section-header + chip + first-item spacing:
...
- [#255](https://github.com/One-Impression/amplify-design-system/pull/255) [`5b31267`](https://github.com/One-Impression/amplify-design-system/commit/5b31267ded1d26369fe4e44cf975ff7da04fb6b7) Thanks [@achin-oi](https://github.com/achin-oi)! - Fix chip taps + add scrollable chip rows.
...
- [#249](https://github.com/One-Impression/amplify-design-system/pull/249) [`dc1b546`](https://github.com/One-Impression/amplify-design-system/commit/dc1b54636f347cc265da7b01348dc72d7ab77d81) Thanks [@achin-oi](https://github.com/achin-oi)! - Rename `region` → `ui_zone` across the page-scaffold/reload model, matching `@one-impression/sdk-native-sdui@4.0.0`. BREAKING — the runtime now reads `reload.payload.ui_zones` (not `regions`), so a BFF must emit `ui_zones`; the SDK peer is bumped to `^4.0.0`.
...
- [#227](https://github.com/One-Impression/amplify-design-system/pull/227) [`3fd5876`](https://github.com/One-Impression/amplify-design-system/commit/3fd5876e2f9b4850b6b744dc11596f0c0201df19) Thanks [@achin-oi](https://github.com/achin-oi)! - Viewport-visibility lifecycle + backend-driven infinite-scroll feeds.
...
- [#225](https://github.com/One-Impression/amplify-design-system/pull/225) [`4634db8`](https://github.com/One-Impression/amplify-design-system/commit/4634db88bdba0451e7215659c2f8b8448dc80f89) Thanks [@achin-oi](https://github.com/achin-oi)! - Validate the composite snippet against the typed SDK schema.
